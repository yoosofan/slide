...
.. prezento:: Operating Systems - Memory  (By Ahmad Yoosofan)
...
.. slido:: Fixed Partitioining or Static Partitioning
   :class: t2c
    ...
    .. image:: os/img/memory/memory_fixed_partitioning.png
       :align: center
       :height: 600px
    ...
    * .. image:: os/img/memory/memory_fixed_partitioning_internal_fragmentation.png
    ...
    .. :
        ...
        .. image:: os/img/memory/memory_fixed_allocation.png
           :align: center
        ...
        .. image:: os/img/memory/memory_management_pc.png
           :align: center
           :height: 470px

.. slido:: Dynamic Partitioning
   :class: t2c
...
.. slido:: Compaction or Defragmentation
    ...
    * Cons
    ...
    .. :
        ...
        .. image:: os/img/memory/compaction.svg
           :align: center
...
.. slido:: Buddy System Memory Management(I)

    .. image:: os/img/memory/memory_buddy_system2.png
       :align: center
...
.. slido:: Buddy System Memory Management(III)
    ...
    .. :
        ...
        .. image:: os/img/memory/memory_buddy_system1.png
           :align: center
           :height: 500px
    ...
    .. :
        ...
        .. image:: os/img/memory/memory_buddy_system3.png
           :align: center
   ...
   :class: t2c
    ...
    .. container:: step
        ...
        **Process Control Block (PCB)**
        ...
        .. image:: os/img/in/pcb01.png
           :align: center

.. slido::
   :class: n2c

    .. image:: os/img/in/simple_multiple_process.png
       :align: center
...
.. slido::
   :class: n3c
    ...
    .. image:: os/img/memory/base_limit_register.png
       :align: center
       :height: 400px
...
.. slido::
    ...
    .. image:: os/img/memory/memory_linking_function.png
       :align: center

.. slido::
   :class: n2c

    .. image:: os/img/memory/memory_program_address_binding.png
       :align: center
...
.. slido::
    ...
    .. image:: os/img/memory/memory_address_binding_loader.png
       :align: center
...
.. slido:: Blocked or Waiting
   :class: t2c
    ...
    .. image:: os/img/in/system_call02.png
       :align: center
...
.. slido:: Process Suspension
   :class: t2c
    ...
    .. image:: os/img/memory/swapping_processes.png
       :align: center

    .. image:: os/img/memory/suspend_state.png
       :align: center
       :width: 500px
       :height: 500px
...
.. slido:: Memory Overlays
   :class: t2c

    .. image:: os/img/memory/memory_ovelay_turbo_c.jpg
       :align: center
       :width: 500px
       :height: 600px
...
.. slido:: Cache Memory & Locality
   :class: t2c

    .. image:: os/img/memory/memory_hierarchy_1_4_StorageDeviceHierarchy.jpg
       :align: center
       :width: 500px
    ...
    .. :
        ...
        .. image:: os/img/memory/memory_hierarchy_hei.png
           :align: center
...
.. slido:: Cache Management & OS Implications
    ...
    * **The Hidden Cost of Context Switching**
    ...
    .. class: rtl-h1
        ...
        .. image:: os/img/memory/memory_cache_image025.jpg
           :align: center
    ...
    .. image:: os/img/memory/memory_cache_Cache_hierarchy-example.svg
       :align: center
...
.. slido::
    ...
    .. image:: os/img/memory/memory_cache_read_write_algorithm_Write-back_with_write-allocation.svg
       :align: center
       :height: 750px
...
.. slido:: Motherboard
   :class: t2c
    ...
    .. image:: os/img/memory/GigabyteZ77-HD4-Top.jpg
        :align: center
        :height: 650px

.. slido:: Direct Memory Access(DMA)

    .. image:: os/img/memory/system-configuration-with-dmac.png

.. slido:: BIOS
   :class: t2c

    .. image:: os/img/in/simple_poweron_computer.png
       :align: center
    ...
    .. :
        ...
        .. image:: os/img/in/bios.gif
           :align: center

.. slido:: Boot sequence
   :class: t2c

    .. image:: os/img/in/GRUB_with_ubuntu_and_windows_vista.png
        :align: center
        :width: 600px
...
.. slido:: Microkernel Architecture
   :class: t2c
    ...
    .. image:: os/img/in/micro_kernel01.png
       :align: center
       :width: 550px
...
.. slido:: Multi Layer
    ...
    .. image:: os/img/in/multilayer_os01.png
       :align: center
