...
if __name__ == "__main__":
    ...
    # parser.add_argument("name", help="input file to tokenize", type=str)
    parser.add_argument("-f", "--filename", default='test.prog.pr', help="input file to tokenize", type=str)
    args = parser.parse_args()
    with open(args.filename, mode='r', encoding='utf-8') as f1:
