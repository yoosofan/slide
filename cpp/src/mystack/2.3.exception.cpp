...
#include <cmath>
using namespace std;
void f1(int i){if( i <= 0)   throw i;else    cout << i<<endl;}
void f2(int mm){if (mm > 20)    throw mm;else    cout<<mm<<endl;}
void f4(int mm){char s1[20]="ldkjfld";if(mm<10) throw s1;cout << "In f4 mm "<< mm<<endl;}
void f3(void){
  try {f1(3);f4(2);}catch(int mm){cout <<"In f3 "<<mm<<endl;}
}
...
int main(){
  ...
  try{int i=0; cout<<2/i<<endl;}catch(...){cout<<"catch"<<endl;}
  cout<< "End "<<endl;
  return 0;
}
