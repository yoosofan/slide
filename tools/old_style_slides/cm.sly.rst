...
.. slido:: Sly
    ...
    * Copy SLY folder
    ...
    .. container::
        ...
        .. include:: cm/src/sly/222.plus.py
          :code: python
          :number-lines:
...
.. slido:: Simple Error handling
   :class: t2c

    .. include:: cm/src/sly/233.error.py
      :code: python
      :number-lines:
...
.. slido:: Converting Value Based on Type
   :class: t2c

    .. include:: cm/src/sly/244.plus.py
      :code: python
      :number-lines:
...
.. slido:: Index of Token in Buffer
   :class: t2c

    .. include:: cm/src/sly/255.index.py
      :code: python
      :number-lines:
...
.. slido:: Just Number Function
   :class: t2c

    .. include:: cm/src/sly/264.just.number.function.py
      :code: python
      :number-lines:
...
.. slido:: Ignore New Line and One Line Comment
   :class: t2c

    .. include:: cm/src/sly/274.ignore.lines.py
      :code: python
      :number-lines:
...
.. slido:: Counting Lines (Error)
   :class: t2c

    .. include:: cm/src/sly/280.lineno.wrong.py
      :code: python
      :number-lines:
...
.. slido:: Line Number of Tokens
   :class: t2c

    .. include:: cm/src/sly/284.lineno.py
      :code: python
      :number-lines:
...
.. slido:: Token Remapping
   :class: t2c

    .. include:: cm/src/sly/322.token.remapping.py
      :code: python
      :number-lines:
...
.. slido:: More Token Type
   :class: t2c

    .. include:: cm/src/sly/524.more.tokens.py
      :code: python
      :number-lines:
...
.. slido:: Longer Tokens before Short Tokens
   :class: t2c

    .. include:: cm/src/sly/544.longer.before.shorter.py
      :code: python
      :number-lines:
...
.. slido:: Longer Tokens before Short Tokens(Error)
   :class: t2c

    .. include:: cm/src/sly/555.longer.before.shorter.error.py
      :code: python
      :number-lines:
...
.. slido:: Adding Match Actions
   :class: t2c

    .. include:: cm/src/sly/575.adding.match.actions.py
      :code: python
      :number-lines:
...
.. slido:: Literals(I)
   :class: t2c
    ...
    .. include:: cm/src/sly/584.literal.I.py
      :code: python
      :number-lines:
...
.. slido:: Literals(II) - Do Something
   :class: t2c

    .. include:: cm/src/sly/588.literal.II.py
      :code: python
      :number-lines:
...
.. slido:: Complete Example
   :class: t2c

    .. include:: cm/src/sly/624.complete.example.py
      :code: python
      :number-lines:
      :start-line: 1
...
.. slido:: Syntax Analysis(Recursive Descendant)
