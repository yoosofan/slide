...
.. prezento:: Databse System, relations (By Ahmad Yoosofan)
   :skip-help: true
...
.. slido:: Data or Quantitative data
...
.. slido:: Quantitative Data Examples
...
.. slido:: Advantages of Quantitative Data
...
.. slido:: Old models for Storing Data
...
.. slido:: Relational Model

    * Table
    * Field
    * Record

.. slido:: Sales DataBase (1)
...
.. slido:: Parts Suppliers Database

    * P(pn_, pname, color, weight, city)
    * S(sn_, sname, status, city)
    * SP(sn_, pn_, qty)

.. slido:: Parts, Suppliers and Projects Database
...
.. slido:: Relational Model Like Table

    .. image:: db/img/relational_model/Relational_model_concepts.png
        :align: center
...
.. slido::
    ...
    .. image:: db/img/relational_model/Student-Relational-Model-diagram.jpg
        :align: center
...
.. slido:: Cartesian Product(I)

    X × Y = { (x, y) ∣ x ∈ X ∧ y ∈ Y}

    .. image:: db/img/relational_model/CartesianProduct.jpg
        :align: center
        :width: 400px
        :height: 260px
...
.. slido:: Cartesian Product(I)
    ...
    .. image:: db/img/relational_model/cartesianproduct1.svg
        :align: center
        :width: 300px
        :height: 200px
...
.. slido:: Get supplier names who supply any part
   :class: t2c
...
.. slido:: Get supplier names for suppliers that supply part P4
   :class: t2c
...
.. slido:: Get supplier city for suppliers that supply Red parts(I)
   :class: t2c
...
.. slido:: Get supplier city for suppliers who supply Red parts(II)
   :class: t2c
...
.. slido:: Get supplier city for suppliers who supply Red parts(III)
   :class: t2c
...
.. slido:: Candidate Keys کلیدهای نامزد
   :class: t2c
...
.. slido:: Surrogate Keys vs. Natural Keys
   :class: t2c
...
.. slido:: Company, Project Name duplication
   :class: t2c
...
.. slido:: Company with Departments
   :class: t2c
