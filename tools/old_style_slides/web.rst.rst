...
.. prezento:: rst (By Ahmad Yoosofan)
   :skip-help: true
   :css: assets/assets/style.css
   :substep: true
   :slide-numbers: true

.. slido:: Restructured Text
...
.. slido:: Why do we need another language?
...
.. slido:: Install docutils or sphinx
...
.. slido:: Escaping with Backslashes
...
.. slido:: include Code
   :class: t2c
    ...
    .. code:: rst
      ...
      .. include:: web/src/rst/code22.cpp
          :code: cpp
          :number-lines:
          :start-line: 2
          :end-line: 18
...
.. slido:: Raw
   :class: t2c
    ...
    .. code:: rst
        ...
        ..  raw:: html
            :file: web/src/header.html

.. slido:: Simple Table(I)
   :class: t2c
...
.. slido:: CSV Table(III)
    ...
    .. code:: rst
        ...
        .. csv-table:: Table Title
           :file: web/CSV file path and name
           :widths: 30, 70
           :header-rows: 1
...
.. slido:: Check csv file and errors
...
.. slido:: Rules for creating CSV files
...
.. slido:: Substitution References and Definitions
   :class: t2c
