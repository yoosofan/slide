.. prezento:: DB - Normalization

.. slido:: هنجارسازی (نرمال سازی) Normalization
...
.. slido:: نرمال سطح ۱
    ...
    ..  csv-table:: جدول فروش یک فروشگاه
        :header-rows: 1
        :file: db/normalization/wrong.normal.1.csv
...
.. slido:: نرمال سطح چهارم

    .. list-table::
      :class: ltr

      * - .. raw:: html
                :file: db/normalization/ssn_sport_book.html
...
.. slido:: Adding ISBN for books in Library
   :class: t2c
...
.. slido:: Adding Category in Library
   :class: t2c
...
.. slido:: Library with Return dates and limited days
...
.. slido::
    ...
    .. image:: db/img/relational_model/university_relations.png

    .. :

      :width: 800px

.. slido:: University Database(I)
   :class: t2c
...
.. slido:: Rules for Foreign Key(FK)
   :class: t2c
...
.. slido:: Core Principles of Referential Integrity
