...
.. prezento:: css layout grid (By Ahmad Yoosofan)
   :skip-help: true
   :css: assets/assets/hovercraft.css assets/css.css grid.css
   :substep: true
   :slide-numbers: true
...
.. slido:: Grid Container - display grid
   :class: t2c

    .. include:: web/src/grid/grid220.html
        :code: html
        :number-lines:
        :start-line: 7
        :end-line: 14

    .. include:: web/src/grid/grid220.css
        :code: html
        :number-lines:
...
.. slido:: Grid Container - display inline-grid
   :class: t2c

    .. include:: web/src/grid/grid230.html
        :code: html
        :number-lines:
        :start-line: 7
        :end-line: 14

    .. include:: web/src/grid/grid230.css
        :code: html
        :number-lines:
