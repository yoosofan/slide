...
.. slido:: Ignoring Some Characters
...
.. slido::
    ...
    .. include:: cm/src/la/template.in.template.cpp
      :code: cpp
      :number-lines:
      :class: ltr
      :start-line: 47
...
.. slido:: Relational Operators

    .. image:: cm/img/relop.png
...
.. slido::
   :class: t2c
    ...
    .. include:: cm/src/la/lexical440.cpp
      :code: cpp
      :number-lines:  12
      :class: ltr
      :start-line: 11
...
.. slido::
   :class: t2c
    ...
    .. include:: cm/src/la/lexical455.cpp
      :code: cpp
      :number-lines: 9
      :class: ltr
      :start-line: 8
...
.. slido::
    ...
    .. image:: cm/img/keyword2.png

.. slido:: Number

    1, 322, 34.34, 34E3, 34E-3

    .. image:: cm/img/number.png
      :width: 740px

.. slido:: Delimiter

    .. image:: cm/img/delim.png

.. slido:: Psudo Code

    .. image:: cm/img/psudocode1.png
      :height: 500px

.. slido::

    .. image:: cm/img/full_chart.png
      :width: 800px
...
.. slido:: Keywords in Symbol Table
   :class: t2c
    ...
    .. include:: cm/src/la/symbol_table34.cpp
      :code: cpp
      :number-lines:

.. slido::

    .. image:: cm/img/la/token_state_machine_no_keywords.png

.. slido::

    .. include:: cm/src/la/scanner1.cpp
      :code: cpp
      :number-lines:
      :end-line: 34
...
.. slido:: Some References of Regular Expression
...
.. slido:: Online Regular Expression Tools
...
.. slido:: Regular Expression in Programming(re/regex)
