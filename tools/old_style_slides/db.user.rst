...
.. slido::
    ...
    .. image:: db/img/users/several_users.png

    .. reference:

        https://www.sqlshack.com/drop-sql-server-login-dependencies/

.. slido:: Users in general

    Application users

.. slido:: 2 tier architecture

    .. image:: db/img/users/aplication_user.gif

    .. reference:

        https://docs.oracle.com/cd/B28196_01/idmanage.1014/b15994/concepts.htm

.. slido:: 3 tier architecture

    .. image:: db/img/users/3-tier-architecture_W640.jpg
...
.. slido:: 2 vs 3 tier architecture

    .. image:: db/img/users/2_3_tier_architecture.jpg
...
.. slido:: 3 tier architecture
    ...
    .. image:: db/img/users/A_Typical_3_Tier_Server_Architecture.jpg
...
.. slido:: N-tier_architecture

    .. image:: db/img/users/N-tier_architecture.png
