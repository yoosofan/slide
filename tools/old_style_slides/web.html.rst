.. prezento:: WEB - Html
   :skip-help: true
   :css: assets/assets/hovercraft.css assets/html.css
   :substep: true
...
.. slido:: Old Persian cuneiform

    .. image:: web/img/105px-Old_Persian_cuneiform.jpg

.. slido:: Darius the Great (circa 490 BC)

    .. image:: web/img/Tomb_of_Darius_I_DNa_inscription_part_II.jpg
...
.. slido:: EBCDIC(IBM - 8bit) 1963

    .. :

      .. image:: web/img/ebcdic.jpg

    .. image:: web/img/ebcdic01.gif
...
.. slido:: ASCII(ANSI - 7bit) 1963

    .. image:: web/img/ascii.png

    .. :

      https://en.wikipedia.org/wiki/ASCII

.. slido:: How a document can be formatted
...
.. slido::
    ...
    .. image:: web/img/rfc20.png

.. slido::

    .. image:: web/img/rfc768.png

.. slido::

    .. image:: web/img/rfc821.png

.. slido::

    .. image:: web/img/rfc821-2.png
...
.. slido::
    ...
    .. image:: web/img/windows-1256.gif
...
.. slido:: UTF-8
    ...
    .. image:: web/img/ucs-utf8.png

    .. image:: web/img/utf8example.png
...
.. slido::
   :id: html-dom-model-image-id
    ...
    .. image:: web/img/800px-DOM-model.svg.png
...
.. slido:: Direction (dir : rtl , ltr)
   :id: dir-rtl-id

    .. include:: web/src/css/css210.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html180_rtl.html
        :code: html
        :number-lines:
...
.. slido:: Direction (in tags dir : ltr)
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html220_h1.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html240_p.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html260_p_div.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html280_br.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html300_a.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html320_ul.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html330_ol.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html330_ol_ol.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html340_img.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html350_img_width_height.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html360_img_alt.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html370_pre.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html375_b_strong_i.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html375_em_small_del.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html375_ins_sub_sup.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html380_hr_sub_sup.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html385_table_tr_td.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html390_table_border.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html395_table_different_td.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html400_table_different_td_colspan.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html405_table_different_td_rowpan.html
        :code: html
        :number-lines:
...
.. slido:: Center Tag
   :class: t2c
    ...
    .. include:: web/src/html/html410_table_center.html
        :code: html
        :number-lines:
        :start-line: 7
        :end-line: 35
...
.. slido:: Remove Center Tag
   :class: t2c

    .. include:: web/src/html/html412_remove_table_center.html
        :code: html
        :number-lines:
        :start-line: 7
        :end-line: 36
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html415_table_thead.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html420_table_tfoot.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html420_table_caption.html
        :code: html
        :number-lines:
...
.. slido:: Comments & Named Characters

    .. include:: web/src/html/html422_entries_quote.html
        :code: html
        :number-lines:
...
.. slido:: Absolute URLs vs. Relative URLs
   :class: t2c

    .. include:: web/src/html/html424_absolute_url_vs_relative_urls.html
        :code: html
        :number-lines:
        :start-line: 6
        :end-line: 17
...
.. slido:: HTML Links - Use an Image as a Link
   :class: t2c

    .. include:: web/src/html/html426_use_an_image_as_a_link.html
        :code: html
        :number-lines:
        :start-line: 6
        :end-line: 10
...
.. slido:: Link to an Email Address
...
.. slido:: Link Target
   :class: t2c
    ...
    .. include:: web/src/html/html428_link_target.html
        :code: html
        :number-lines:
        :start-line: 6
        :end-line: 30
...
.. slido:: Title Attribute
   :class: t2c

    .. include:: web/src/html/html550_title.html
        :code: html
        :number-lines:
...
.. slido:: Abbr Tag
   :class: t2c
    ...
    .. include:: web/src/html/html555_abbr.html
        :code: html
        :number-lines:
...
.. slido:: rtl Attribute
   :class: t2c
    ...
    .. include:: web/src/html/html505_div.html
        :code: html
        :number-lines:
...
.. slido:: Span Tag
   :class: t2c
    ...
    .. include:: web/src/html/html505_span_div.html
        :code: html
        :number-lines:
...
.. slido:: Image is nonblock
   :class: t2c

    .. include:: web/src/html/html506_use_an_image_as_a_link_nonblock.html
        :code: html
        :number-lines:
        :start-line: 6
        :end-line: 19
...
.. slido:: Semantic Tags
    ...
    * aside
    ...
    .. image:: web/img/html_semantic_tags.png

    .. :

      https://www.w3schools.com/html/html5_semantic_elements.asp

.. slido:: Block / Non Block Element
...
.. slido:: Blockquote
   :class: t2c
    ...
    .. include:: web/src/html/html507.blockquote.html
        :code: html
        :number-lines:
...
.. slido:: Short quotations
   :class: t2c

    .. include:: web/src/html/html507.quotations.html
        :code: html
        :number-lines:
        :start-line: 6
        :end-line: 19
...
.. slido:: HTML <bdo> for Bi-Directional Override
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html510_dl_dt_dd.html
        :code: html
        :number-lines:
...
.. slido::
   :class: simple-html01-class
    ...
    .. include:: web/src/html/html615_class.html
        :code: html
        :number-lines:
...
.. slido:: Tab
   :class: t2c
    ...
    .. include:: web/src/html/html620_tabindex.html
        :code: html
        :number-lines:
...
.. slido:: Access Key
   :class: t2c
    ...
    .. include:: web/src/html/html645_acceskey.html
        :code: html
        :number-lines:
...
.. slido:: SEO
    ...
    **Lang Attribute**
    .. include:: web/src/html/html630_lang.html
        :code: html
        :number-lines:
...
.. slido:: Content Editable Attribute
   :class: t2c

    .. include:: web/src/html/html635_contenteditable.html
        :code: html
        :number-lines:
...
.. slido:: Hidden Attribute
   :class: t2c
    ...
    .. include:: web/src/html/html640_hidden.html
        :code: html
        :number-lines:
...
.. slido:: List(I)
   :class: t2c
    ...
    .. include:: web/src/html/html660_ol_start.html
        :code: html
        :number-lines:
...
.. slido:: List(II)
   :class: t2c
    ...
    .. include:: web/src/html/html662_ol_type.html
        :code: html
        :number-lines:
...
.. slido:: List(III)
   :class: t2c
    ...
    .. include:: web/src/html/html665_ul_type.html
        :code: html
        :number-lines:
...
.. slido:: Disabled
   :class: t2c
    ...
    .. include:: web/src/html/html680_bottom.html
        :code: html
        :number-lines:
...
.. slido:: Select / option
   :class: t2c
    ...
    .. include:: web/src/html/html685_select.html
        :code: html
        :number-lines:
...
.. slido:: Input
   :class: t2c
    ...
    .. include:: web/src/html/html690_input.html
        :code: html
        :number-lines:
...
.. slido:: Fieldset
   :class: t2c
    ...
    .. include:: web/src/html/html695_fieldset.html
        :code: html
        :number-lines:
...
.. slido:: Area(I)
   :class: t2c
    ...
    .. include:: web/src/html/html730_area.html
      :code: html
      :number-lines:
...
.. slido:: Area(II)
   :class: t2c
    ...
    .. include:: web/src/html/html735_area.html
      :code: html
      :number-lines:
