...
.. prezento:: HTML (By Ahmad Yoosofan)
   :skip-help: true
   :css: assets/assets/hovercraft.css assets/css.css
   :substep: true
   :slide-numbers: true

.. slido:: Cascade Style Sheet (CSS)
...
.. slido:: Simple Tag Selector
   :class: t2c

    .. include:: web/src/css/css220.html
        :code: html
        :number-lines:
...
.. slido:: Selector(I) Sample
   :class: t2c

    .. include:: web/src/css/css230.html
        :code: html
        :number-lines:
...
.. slido::
    ...
    .. image:: web/img/css/css-declaration-small.png
...
.. slido:: Selector(II) Sample
   :class: t2c

    .. include:: web/src/css/css240.html
        :code: html
        :number-lines:
...
.. slido:: Selector(III) Sample
   :class: t2c

    .. include:: web/src/css/css250.html
        :code: html
        :number-lines:
...
.. slido:: Box Model(I)
    ...
    .. image:: web/img/css/boxmodel.png
      :width: 500px
      :height: 400px
...
.. slido:: Shorthand Style Order(II)
...
.. slido:: Selector(IV): Selecting multiple element
...
.. slido::
   :class: t2c
    ...
    .. include:: web/src/css/css320_combinator.html
        :code: html
        :number-lines:
...
.. slido:: Selector(VI): Combinator(II)
...
.. slido:: Selector(VII): Combinator(III)
...
.. slido:: Selector(VIII): Compounding multiple ID selectors
...
.. slido:: Selector(IX): Compounding multiple class selectors
...
.. slido:: Selector(X): Universal selectors
...
.. slido:: Selector(XI): Attribute selectors(I)
...
.. slido:: Selector(XII): Attribute selectors(II)
...
.. slido:: Selector(XIII): Attribute selectors(III)
...
.. slido:: Font Variant, Line Height, and Text Transform
...
.. slido:: Selector() :nth-of-type()/:nth-of-last-type()
...
.. slido:: CSS Selectors pseudo classes
   :class: t2c
...
.. slido:: Media features / monochrome
...
.. slido:: Media features / oreintation
...
.. slido:: Media features / resolution
...
.. slido:: Layer simple Example
   :class: t2c

    .. include:: web/src/css/css3242.html
        :code: html
        :number-lines:
...
.. slido:: Assigning rules to existing layers
   :class: t2c
...
.. slido:: Support CSS
   :id: dir-rtl-id
    ...
    .. image:: web/img/css_grid_support.png
      :width: 950px
...
.. slido:: Improve Responsiveness with flex-wrap in CSS
...
.. slido:: Testing Css flexbox

    * https://flexbox.help/
    * https://www.cssmine.com/ebook/flexbox-examples

.. slido:: CSS Only Magic
...
.. slido:: Remove Unnecessary Sections
...
.. slido:: Add Supplementary Content(I)
...
.. slido:: Add Supplementary Content(II)
