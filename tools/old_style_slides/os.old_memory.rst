...
.. slido:: Memory Management

    مدیریت حافظه

.. slido:: Memory of a process

    حافظهٔ یک فرآیند

.. slido:: بخش‌های درونی یک فرآیند در حالت کلی

    .. image:: os/img/memory/memory_precess_addressing_parts.png
       :align: center

.. slido:: مشخص شدن آدرس‌های حافظهٔ یک فرایند از زمان نوشته شدن برنامه تا زمان اجرای فرآیند
...
.. slido:: تخصیص حافظهٔ پیوسته به فرآیندها
...
.. slido:: تخصیص حافظه به فرآیندها در حالت بخش‌بندی ثابت حافظه
...
.. slido:: شمارندهٔ برنامه و فرآیندهای درون حافظه
...
.. slido::
    ...
    .. image:: os/img/memory/memory_paging_typical_page_table_entry.png
       :align: center
       :scale: 60%
...
.. slido::
    ...
    .. image:: os/img/memory/memory_paging_page_table_and_cache.png
       :align: center
       :scale: 70%
...
.. slido:: صفحه‌بندی با جدول صفحهٔ معکوس
...
.. slido:: روش شناسایی کوبیدگی به کمک مدل مجموعهٔ کاری
