.. prezento:: Operating Systems: Thread
   :skip-help: true
   :css: ./assets/style.css ./thread.css
   :substep: true
   :slide-numbers: true
   :skip-help: true
   :data-width: 1024
...
.. slido:: Python Thread (III)
   :id: thread-in-python-iii-id

    .. include:: os/src/thread/240.py
      :number-lines:
      :code: python
...
.. slido:: Thread Python join(I)
   :id: thread-in-python-join-i-id

    .. include:: os/src/thread/260.py
      :number-lines:
      :code: python
...
.. slido:: Array of Thread
   :id: cpp-thread-func-array-id
    ...
    .. include:: os/src/thread/640.cpp
      :number-lines:
      :code: cpp
      :class: substep

    .. include:: os/src/thread/640_out10.txt
      :code: console
      :class: substep

.. slido:: Array of Thread output
   :id: cpp-thread-func-array-out-id

    .. include:: os/src/thread/640_out20.txt
      :code: console
      :class: substep

    .. include:: os/src/thread/640_out40.txt
      :code: console
      :class: substep

.. slido:: Array of Thread output(II)
...
.. slido:: Threads and Processes
    ...
    .. image:: os/img/thread/a3processes.vs.b1process3thread.png
       :align: center

.. slido:: Many to One Thread

    .. image:: os/img/thread/many2one.svg
       :align: center
       :width: 300px
       :height: 400px

.. slido:: Different Types of Threads

    .. image:: os/img/thread/thread.user_level.kernel.level.png
       :align: center
       :width: 500px
       :height: 350px

.. slido:: User and Kernel Thread
    ...
    *  kernel threads
    ...
    .. :
      ...
      .. image:: os/img/thread/thread_One_to_one_model.png
         :align: center

      ----

      .. image:: os/img/thread/thread_many_to_many_model.png
         :align: center

.. slido::

    .. image:: os/img/thread/thread.A.user_level.threads.package.b.A.threads.package.managed.by.the.kernel.png
       :align: center
       :width: 500px
       :height: 350px
    ...
    .. :
      ...
      .. image:: os/img/thread/thread_two_level_model.png
         :align: center

      ----

      .. image:: os/img/thread/Actual_Parallelism_Vs_Feel_of_Parallelism.jpg
         :align: center
...
.. slido:: ارتباط میان حالت‌های نخ‌ها

    .. image:: os/img/thread/thread.Examples.of.the.Relationships.between.User_Level.Thread.States.and.Process.States.png
       :align: center
       :width: 500px
       :height: 350px

.. slido:: سرویس دهندهٔ وب با چند نخ

    .. image:: os/img/thread/thread.A.multithreaded.Web.server.png
       :align: center
       :width: 500px
       :height: 350px

.. slido:: Threads in Webserver

    .. image:: os/img/thread/thread_Multithreaded_server_architecture.png
       :align: center
       :width: 500px
