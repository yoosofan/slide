...
.. prezento:: javascript1 (By Ahmad Yoosofan)
   :skip-help: true
   :css: assets/assets/hovercraft.css assets/javascript1.css
   :slide-numbers: true
...
.. slido:: Script
   :class: t2c
    ...
    .. include:: web/src/javascript/2444.html
        :code: html
        :number-lines:
...
.. slido:: Document Object Manipulation
...
.. slido:: Examine Document Object(I)
   :class: t2c

    .. include:: web/src/javascript/2516.html
        :code: html
        :number-lines:
...
.. slido:: Examine Document Object(II)
   :class: t2c

    .. include:: web/src/javascript/2523.html
        :code: html
        :number-lines:
...
.. slido:: Examine Document Object(III)
   :class: t2c

    .. include:: web/src/javascript/2525.html
        :code: html
        :number-lines:
...
.. slido:: Examine Document Object(IV)
   :class: t2c

    .. include:: web/src/javascript/2527.html
        :code: html
        :number-lines:
...
.. slido:: Examine Document Object(V)
   :class: t2c

    .. include:: web/src/javascript/2642.html
        :code: html
        :number-lines:
...
.. slido:: GET ELEMENTS BY CLASS NAME
...
.. slido:: GET ELEMENTS BY TAG NAME
...
.. slido:: InnerText vs innerContent
   :class: t2c

    .. include:: web/src/javascript/2672.html
        :code: html
        :number-lines:
...
.. slido:: Click
   :class: t2c
    ...
    .. include:: web/src/javascript/event1.html
        :code: html
        :number-lines:
...
.. slido:: this
   :class: t2c
    ...
    .. include:: web/src/javascript/event2.html
        :code: html
        :number-lines:
...
.. slido:: function
   :class: t2c
    ...
    .. include:: web/src/javascript/event3.html
        :code: html
        :number-lines:
...
.. slido::
    ...
    .. include:: web/src/javascript/jquery.mouse.out.leave.html
        :code: html
        :number-lines:
        :class: ltr
...
.. slido::
   :class: t2c
    ...
    .. include:: web/src/javascript/event_click.html
        :code: html
        :number-lines:
        :class: ltr
        :start-line: 0
...
.. slido::
   :class: t2c
    ...
    .. include:: web/src/javascript/event_onsubmit.html
        :code: html
        :number-lines:
        :class: ltr
        :start-line: 0
