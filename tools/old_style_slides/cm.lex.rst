...
.. slido:: Install and Compile Lex File
   :class: t2c

    .. include:: cm/src/lex/01.count_words.l
      :code: cpp
      :number-lines:
...
.. slido::
   :class: scrollbar-box800x500px-overflow
    ...
    .. include:: cm/src/lex/01.count_words.c
      :code: c
      :number-lines:
...
.. slido:: Count words(I)
   :class: t2c
    ...
    .. container::
      ...
      .. include:: cm/src/lex/count_words_input_1.txt
        :code: text
        :number-lines:
...
.. slido:: Count words(II)
   :class: t2c

    .. container::

      .. include:: cm/src/lex/02.count_words.l
        :code: cpp
        :number-lines:
...
.. slido:: Count words(III)-input(I)
   :class: t2c

    .. container::

      .. include:: cm/src/lex/04.count_words.l
        :code: cpp
        :number-lines:
...
.. slido:: Count words(III)-input(II)
   :class: t2c
    ...
    .. container::
      ...
      .. include:: cm/src/lex/count_words_input_2.txt
        :code: text
        :number-lines:
...
.. slido:: Simple Number
   :class: t2c
    ...
    .. container::
      ...
      .. include:: cm/src/lex/05.simpleNumber.l
        :code: cpp
        :number-lines:

      .. include:: cm/src/lex/05.simpleNumber_input.txt
        :code: text
        :number-lines:
...
.. slido:: Number of Characters
   :class: t2c

    .. include:: cm/src/lex/08.numberOfCharacters.l
      :code: cpp
      :number-lines:

    .. container::

      .. include:: cm/src/lex/08.numberOfCharacters_input.txt
        :code: text
        :number-lines:
...
.. slido:: Parts of Speech(I)
   :class: t2c

    .. include:: cm/src/lex/12.wordsInEnglish1.l
      :code: cpp
      :number-lines:

    .. container::

      .. include:: cm/src/lex/12.wordsInEnglish1.input.txt
        :code: text
        :number-lines:
...
.. slido:: Parts of Speech(II)
   :class: t2c

    .. include:: cm/src/lex/testBetterWordInEnglishComment.txt
      :code: text
      :number-lines:
...
.. slido:: Parts of Speech(III)
   :class: t2c

    .. include:: cm/src/lex/wordsTypeInEnglish.l
      :code: c
      :number-lines:
      :start-line: 0
      :end-line: 28
...
.. slido:: Similar Lexer and Parser
...
.. slido:: PLY / lex part
    ...
    * https://github.com/dabeaz/ply/tree/master/src/ply
    ...
    .. image:: cm/img/ply.github.png

.. slido:: Sample I

    .. include:: cm/src/ply/115.id.plus.py
      :code: python
      :number-lines:

.. slido:: Sample II

    .. include:: cm/src/ply/124.plus.py
      :code: python
      :number-lines:

.. slido:: Sample III

    .. include:: cm/src/ply/126.error.plus.py
      :code: python
      :number-lines:
...
.. slido:: Sample IV
   :class: t2c
    ...
    .. include:: cm/src/ply/128.plus.mul.py
      :code: python
      :number-lines:
      :end-line: 21
...
.. slido:: Sample VI
   :class: t2c
    ...
    .. include:: cm/src/ply/132.assign.py
      :code: python
      :number-lines:
      :end-line: 23
...
.. slido:: Sample VII
   :class: t2c
    ...
    .. include:: cm/src/ply/133.comp.py
      :code: python
      :number-lines:
      :end-line: 21
...
.. slido:: Sample VIII
   :class: t2c
    ...
    .. include:: cm/src/ply/134.newline.py
      :code: python
      :number-lines:
      :end-line: 29
...
.. slido:: A calculator
   :class: t2c
    ...
    .. include:: cm/src/ply/140.plus.py
      :code: python
      :number-lines:
      :end-line: 23
